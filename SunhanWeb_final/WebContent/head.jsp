...
<head>
 ...
 <!-- Google Fonts -->
  ...
  <link href="resoures/css/font-awesome.min.css" rel="stylesheet">
  <link href="resoures/css/owl.carousel.min.css" rel="stylesheet">
  <!-- Template Main CSS File -->
  <link href="resoures/css/headstyle.css" rel="stylesheet">
  <link href="resoures/css/headcustom.css?ver=2.2" rel="stylesheet"> 
  ...
  <header id="header" class="fixed-top">
       ...
       <div class="text-right container">
         <ul class="topbar">
                   <c:choose>
						...
						<c:otherwise>
        				   <li><a href="login.do" id="hddh">로그인</a></li>
    ...
    <div class="container header2">
      ...
      <div class="logo float-left">
        ...
        <a href="main.jsp" class="scrollto"><img src="resoures/images/logo.png" alt="" class="img-fluid" style="height: 47px"></a>
      </div>
